    ...
    <div class="dialog-list-wrapper" v-if="!ifNewGroup">
      ...
      >
        ...
        <div
          ...
          v-show="shelfCategory.id === item.id"
        >
...
import { removeAddFromShelf, appendShelf, computId } from "../../utils/store";
        ...
        this.shelfList.filter((book) => {
          if (book.itemList) {
            book.itemList = book.itemList.filter(
              (book2) => this.shelfSelected.indexOf(book2) < 0
            );
          }
